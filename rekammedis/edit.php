    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            ...
            <form action="proses.php" method="post">
                ...
                <div class="form-floating mb-3">
                    <textarea class="form-control" name="keluhan" placeholder="Leave a comment here" id="keluhan" style="height: 100px" required><?= $data['keluhan']; ?></textarea>
                </div>
                <div class="form-floating mb-3">
                ...
                <div class="form-floating mb-3">
                    <textarea class="form-control" name="diagnosa" placeholder="Leave a comment here" id="diagnosa" style="height: 100px" required><?= $data['diagnosa']; ?></textarea>
                </div>
                <div class="form-floating mb-3">
